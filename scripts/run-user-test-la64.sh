...
Runs the la64 test chain:
  1. switch the legacy target selection to qemu-virt-la64-pretest if needed
...
system_target=qemu-virt-la64-pretest
...
legacy_qemu_platform=qemu-virt-la64-pretest
