...
| POSIX timer pending occurrence | shared pending owner内的per-registration slot | timer owner只提交identity/overrun并接收锁外回告 | `SI_TIMER` delivery |
