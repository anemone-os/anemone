...
**验证 / Enforcement：** `sys_kill()` 的 process-group branches 与 `ThreadGroup::recv_signal()` 源码审计；`pg-test` 和 LTP runner process-group cleanup 路径。

**最初来源：** [2026-05-27 进程组与会话 stage-1 主干](../../devlog/2026-05-25_to_2026-06-07.md#2026-05-27---进程组与会话-stage-1-主干)。

**当前来源：** live signal syscall / task-topology owner，2026-07-20 源码核验。
