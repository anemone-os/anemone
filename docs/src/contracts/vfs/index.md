...
**Owner：** VFS filesystem-type identity、legacy mount admission protocol 与 local whole-file flock protocol
**覆盖范围：** 本轮按触达提取的 canonical filesystem identity、mount source-kind admission、syscall-only fstype alias containment与inode-associated local flock
