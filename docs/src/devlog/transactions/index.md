...
- [System Target Model](./2026-07-22-system-target-model.md)：R2 Stage 1-4与Checkpoint 1A-1D、2A-2D、3A、4A已关闭；Stage 4增加closed Source app driver并复用公共artifact export，Stage 5保持Outline / Not Resolved；`BOOT-PROTOCOL-001`保持effective baseline。
