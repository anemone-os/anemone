...
- [Network Frame Path](./2026-07-26-net-frame-path.md)：R0 Stage 1 Checkpoint 1-4 与 stage-wide review 已关闭；
  Stage 2 保持未解析、未授权的 Outline，全部 network contract 仍 Not Effective。
