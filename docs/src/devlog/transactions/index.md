...
- [Epoll](./2026-07-26-epoll.md)：R1 Stage 0-1 已关闭，subscription 与 opened-description foundation contract 已生效；2R已以operation-serialized bounded scan与non-sleeping wait publication修复2D发现的active-wait blocker并独立关闭。2D仍Suspended且需新的activation；epoll ABI、iomux R1 Refine与三个`EPOLL-*` ID保持Not Cut Over。
