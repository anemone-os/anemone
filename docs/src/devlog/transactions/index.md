...
- [VFS Make Node](./2026-07-31-vfs-make-node.md)：R0已接受；Stage 1与`DEVICE-NUMBER-CUTOVER`已关闭，
  `DEVICE-NUMBER-001`现为effective 12/20 category-neutral baseline。Stage 2仍为Outline / Not Active，
  `1 -> 2` resolution未运行。
