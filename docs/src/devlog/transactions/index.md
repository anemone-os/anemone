...
- [Network UDP](./2026-07-29-net-udp.md)：R0已接受；0A-0C与Stage 0已按positive topology decision关闭；
  `0 -> 1`resolution选择per-provider worker + domain-owned single Stack access window，Stage 1现为Ready / Not
  Active。`NET-UDP-DOMAIN-CUTOVER`与Stage 2均未授权，current contracts未变。
