...
- [Network UDP](./2026-07-29-net-udp.md)：R0已接受；Stage 0 positive topology decision与Stage 1 initial-domain/
  ...
  3C nonblocking datagram。3A已按Contract Impact=None独立关闭；3B implementation/validation candidate因final
  review的两个Apollyon、一个Keter及VFS write-set expansion保持Review Hold。3C仍Ready / Not Active，全部Socket/
