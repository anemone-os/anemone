...
- [System Target Model](./2026-07-22-system-target-model.md)：R2 Stage 1-3与Checkpoint 1A-1D、2A-2D、3A已关闭；Stage 3后feedback correction已删除无consumer的physical firmware typed metadata；Stage 4已解析为单一Checkpoint 4A并保持Ready / Not Activated，`BOOT-PROTOCOL-001`保持effective baseline。
