...
- [System Target Model](./2026-07-22-system-target-model.md)：R0 Stage 1的Checkpoint 1A-1D已关闭；Stage 2保持Outline且resolution gate尚未进入，`BOOT-PROTOCOL-001`保持effective baseline。
