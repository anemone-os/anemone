...
- [System Target Model](./2026-07-22-system-target-model.md)：R0 Stage 1的Checkpoint 1A-1D与Stage 2 Checkpoint 2A-2B已关闭；2C保持Ready / Not Activated，`BOOT-PROTOCOL-001`保持effective baseline。
