...
- [Flock](./2026-07-29-flock.md)：R0已接受且Stage 0已关闭；RV64 KUnit/focused oracle/runtime与LA64 build/rootfs composition通过，LA64 runtime Not Run，全部新contract ID保持Not Effective，下一resolution gate未授权。
