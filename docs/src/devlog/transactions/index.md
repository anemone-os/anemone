...
- [PTY / devpts](./2026-08-11-pty-devpts.md)：Stage 1已关闭，semantic endpoint与physical serial attachment完成分离，
  runtime relation enrollment/retirement已由serial生产路径验证；Stage 2--4未授权，全部target contract仍Not Effective。
