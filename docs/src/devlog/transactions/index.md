...
- [Epoll](./2026-07-26-epoll.md)：R0 Stage 0-1 已关闭，subscription 与 opened-description foundation contract 已生效；epoll core/ABI 与三个 `EPOLL-*` ID 仍未生效，Stage 2 resolution 未授权。
