...
- [Network Frame Path](./2026-07-26-net-frame-path.md)：R1 Stage 2三个checkpoint均已关闭host deterministic
  exhaustion、ownership/progress/pump conformance、provider/recheck/worker hardening与两次fresh-disk RV64
  acceptance；Stage 3已解析为Ready / Not Started / Unauthorized，全部network contract仍Not Effective。
