...
- [TTY Subsystem](./2026-07-23-tty-subsystem.md)：R1 已接受；Stage 0至Stage 3已关闭，`TTY-DATA-CUTOVER`建立五个Active data-plane contract ID。relation/job-control四个ID与`TTY-JOBCTL-CUTOVER`仍Not Cut Over；Stage 4保持Outline / Unauthorized且本轮未解析。
