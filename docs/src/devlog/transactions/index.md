...
- [PTY / devpts](./2026-08-11-pty-devpts.md)：Stage 1 Checkpoint 1已关闭，semantic endpoint与physical serial
  attachment生产路径完成分离；Checkpoint 2及后续Stage未授权，全部target contract仍Not Effective。
