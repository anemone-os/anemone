...
- [Epoll](./2026-07-26-epoll.md)：R0 Stage 0-1 已关闭，subscription 与 opened-description foundation contract 已生效；Stage 2 的 2A dormant watch/lifecycle core 与 2B ready/wait protocol 已关闭，2C-2D 未授权，epoll ABI 与三个 `EPOLL-*` ID 仍未生效。
