...
- [Epoll](./2026-07-26-epoll.md)：R0 Stage 0 已关闭；Stage 1 已完整解析为 Ready / Not Started，只剩 eventfd/fanotify poll bridge 迁移、source-facing trigger/`Armed` 删除与两个 foundation 原子 cutover，尚未授权实现。
