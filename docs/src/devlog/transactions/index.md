...
- [Network Frame Path](./2026-07-26-net-frame-path.md)：R1 Stage 2 Checkpoint 1-2已关闭host deterministic
  exhaustion、ownership/progress/pump conformance与RV64 bounded production-path observability；Checkpoint 3仍
  Not Activated / Unauthorized，全部network contract仍Not Effective。
