...
**Current Phase:** Checkpoint 2B / Gate P1 已关闭；下一步是 Checkpoint 2C - Gate P2 `rq_vtime`、virtual-time arithmetic、eligibility、bounded yield 与 nice-to-weight 可见性
