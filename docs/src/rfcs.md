...
- [RFC-20260726-net-frame-path](./rfcs/net-frame-path/index.md)：R1 Accepted for Implementation；建立 boot-time netdev、
  ...
  RV64负责真实bounded completion/IRQ/reclaim；Stage 2已关闭，Stage 3 Checkpoint 1已用host双实例、
  registry/attach conformance与fresh-disk RV64回归关闭。Stage 3保持Active，Checkpoint 2与cutover仍未授权。执行见
