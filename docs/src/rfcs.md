...
- [RFC-20260810-pty-devpts](./rfcs/pty-devpts/index.md)：Accepted R2；在已关闭的Serial TTY R1之上接受user-mountable
  ...
  建议性必试、sshd不进入验收标准；Stage 3已完成docs-only解析但尚未激活，当前没有Stage执行授权或contract cutover。
