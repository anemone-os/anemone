...
- [RFC-20260711-sched-rt-class](./rfcs/sched-rt-class/index.md)：Draft；定义共享 `Realtime` class 下的 FIFO/RR policy、typed priority、99 个 priority bucket、pending-resched snapshot 接线和分阶段实现 gate。
