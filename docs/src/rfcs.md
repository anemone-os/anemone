...
- [RFC-20260711-sched-rt-class](./rfcs/sched-rt-class/index.md)：已接受进入实现，事务日志见 [2026-07-12-sched-rt-class](./devlog/transactions/2026-07-12-sched-rt-class.md)；定义共享 `Realtime` class 下的 FIFO/RR policy、typed priority、99 个 priority bucket、pending-resched snapshot 接线和原子 class 切换 gate。
