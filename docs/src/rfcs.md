...
- [RFC-20260711-sched-rt-class](./rfcs/sched-rt-class/index.md)：R0 已完成共享 `Realtime` class、FIFO/RR policy、typed priority、99 个 priority bucket 与 RR quantum；R1 已接受并进入实现，修正 class-visible resched cause continuation，以 RR-owned `rotation_due` 表达 committed rotation，并把 pending 收窄为 core-only single bit。R0 证据见 [2026-07-12-sched-rt-class](./devlog/transactions/2026-07-12-sched-rt-class.md)，R1 事务见 [2026-07-14-sched-rt-class-r1](./devlog/transactions/2026-07-14-sched-rt-class-r1.md)。
