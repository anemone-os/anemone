...
- [RFC-20260713-sched-fair-stride](./rfcs/sched-fair-stride/index.md)：已接受进入实现，阶段 0 与 Checkpoint 1-2 已关闭，Checkpoint 3 runtime acceptance待启动；定义稳定 `Fair` class identity、经典 fixed-tick Stride、Linux nice weight、最小 pass heap、placement floor、yield handoff、compile-time default selector 和用户侧 RT/RR A/B 验收边界。事务执行见 [2026-07-13-sched-fair-stride](./devlog/transactions/2026-07-13-sched-fair-stride.md)。
