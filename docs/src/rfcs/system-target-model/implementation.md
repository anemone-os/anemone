...
**Write subset：** `Justfile`、`conf/.defconfig`、`conf/README.md`、`conf/platforms/{example.toml,
schema.jsonc,qemu-virt-rv64.toml,qemu-virt-rv64-pretest.toml,qemu-virt-la64.toml,
...
`conf/README.md`；`conf/platforms/{example.toml,schema.jsonc,qemu-virt-rv64.dts,
...
**计划删除：** tracked `scripts/xtask/src/tasks/mrproper.rs`；2A migration/后续clean删除已确认由旧build
