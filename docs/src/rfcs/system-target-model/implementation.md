...
| Stage 4 | Ready | Source app driver与app/rootfs直接consumer closure | Stage 1-3 Closed；R2 correction Closed；Stage 3 -> Stage 4 resolution完成 | 单一Checkpoint 4A等待独立activation |
