...
逐 syscall 的事实表与 testcase mapping见 [Linux 6.6 Scheduler UAPI Matrix](./backgrounds/linux-6.6-sched-uapi-matrix.md)。以下 phase order属于 R0 binding contract，不是implementation建议。
