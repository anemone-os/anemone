...
**当前修订：** R1
**事务日志：** [2026-07-20-unix-jobctl](../../devlog/transactions/2026-07-20-unix-jobctl.md)；Stage 0、Stage 1、Stage 2、Stage 3A 与 Stage 3B checkpoint 已关闭，Stage 4 Not Started。
...
2026-07-21 的明确授权完成并关闭；Stage 4保持Not Started，不能从3B closure自动进入。
