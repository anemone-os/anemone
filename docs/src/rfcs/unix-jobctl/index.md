...
**下一步：** R0 的 Stage 0、Stage 1、Stage 2 与 Stage 3A checkpoint 已关闭并记录在事务日志；Stage 3B 尚未开始。candidate保持non-publishable，`UJ-CUTOVER` 前不更新 effective contract。
