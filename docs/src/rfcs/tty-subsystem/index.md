...
**下一步：** [Stage 2](./implementation.md#7-stage-2-readyterminal-data-plane-与-tty-data-cutover) 处于Active；Checkpoint 1已关闭，Checkpoint 2已获准实现immutable typed File private-data handoff与TTY FileOps/UAPI/readiness。Checkpoint 3未授权，不得连续进入。
