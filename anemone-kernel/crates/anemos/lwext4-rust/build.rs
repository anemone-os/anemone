...
fn generate_bindings_to_rust(executor: &BuildExecutor, toolchain: &Toolchain, out_dir: &Path) {
    ...
    let mut builder = bindgen::Builder::default()
        ...
        .allowlist_var(
            "^(CONFIG_BLOCK_DEV_CACHE_SIZE|E(EXIST|IO|ISDIR|NOENT|NOTEMPTY|NOTSUP|OK)|EXT4_(DE_(BLKDEV|CHRDEV|DIR|FIFO|REG_FILE|SOCK|SYMLINK|UNKNOWN)|INODE_(BLOCKS|FLAG_EXTENTS)))$",
        )
