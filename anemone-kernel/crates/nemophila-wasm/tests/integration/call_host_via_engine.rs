//! This submodule tests the unusual use case of calling host functions through
//! the engine from the host side.

use nemophila_wasm::{Caller, Config, Engine, Error, Func, Linker, Module, Store};
