...
/// Types implementing this trait may be used as parameters for function
/// execution.
///
/// # Note
///
/// - This is generically implemented by `&[Value]` and tuples of `T: WasmType`
///   types.
/// - Using this trait allows to customize the parameters entrypoint for
///   efficient function execution via the [`Engine`].
///
/// [`Engine`]: [`crate::Engine`]
