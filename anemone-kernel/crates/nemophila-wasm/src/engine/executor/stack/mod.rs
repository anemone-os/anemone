...
impl Stack {
    ...
    /// # Safety
    ///
    /// Any [`FrameSlots`] allocated within the range `from..to` on the
    /// [`ValueStack`] may be invalidated by this operation. It is the
    /// caller's responsibility to reinstantiate all [`FrameSlots`] affected
    /// by this.
    #[inline]
    #[must_use]
