...
impl CachedInstance {
    ...
    /// # Safety
    ///
    /// It is the callers responsibility to use this method only when the caches
    /// are fresh.
    #[inline]
    ...
    /// - calling functions defined in other instances via imported or indirect
    ///   calls
...
impl CachedMemory {
    ...
    /// # Panics
    ///
    /// If the currently used [`Instance`] does not have a default linear
    /// memory.
    ///
    /// [`Memory`]: crate::Memory
    #[inline]
    ...
    /// # Safety
    ///
    /// The user is required to call [`CachedMemory::load_default_memory`]
    ...
    /// Returns an exclusive slice to the bytes of the cached default linear
    /// memory.
    ///
    /// # Safety
    ///
...
impl CachedGlobal {
    ...
    /// # Safety
    ///
    /// The user is required to call [`CachedGlobal::load_global`] according to
    /// its specification.
    #[inline]
