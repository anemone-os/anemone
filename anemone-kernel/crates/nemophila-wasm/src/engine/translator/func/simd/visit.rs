...
impl VisitSimdOperator<'_> for FuncTranslator {
    ...
    fn visit_i8x16_splat(&mut self) -> Self::Output {
        self.translate_simd_splat::<i32, i8>(Op::i8x16_splat, simd::i8x16_splat)
    }

    fn visit_i16x8_splat(&mut self) -> Self::Output {
        self.translate_simd_splat::<i32, i16>(Op::i16x8_splat, simd::i16x8_splat)
    }

    fn visit_i32x4_splat(&mut self) -> Self::Output {
        self.translate_simd_splat::<i32, i32>(Op::i32x4_splat, simd::i32x4_splat)
    }

    fn visit_i64x2_splat(&mut self) -> Self::Output {
        self.translate_simd_splat::<i64, i64>(Op::i64x2_splat, simd::i64x2_splat)
    }

    fn visit_f32x4_splat(&mut self) -> Self::Output {
        self.translate_simd_splat::<f32, f32>(Op::f32x4_splat, simd::f32x4_splat)
    }

    fn visit_f64x2_splat(&mut self) -> Self::Output {
        self.translate_simd_splat::<f64, f64>(Op::f64x2_splat, simd::f64x2_splat)
    }
    ...
    fn visit_i8x16_shl(&mut self) -> Self::Output {
        self.translate_simd_shift::<u8>(Op::i8x16_shl, Op::i8x16_shl_by, simd::i8x16_shl)
    }

    fn visit_i8x16_shr_s(&mut self) -> Self::Output {
        self.translate_simd_shift::<u8>(Op::i8x16_shr_s, Op::i8x16_shr_s_by, simd::i8x16_shr_s)
    }

    fn visit_i8x16_shr_u(&mut self) -> Self::Output {
        self.translate_simd_shift::<u8>(Op::i8x16_shr_u, Op::i8x16_shr_u_by, simd::i8x16_shr_u)
    }
    ...
    fn visit_i16x8_shl(&mut self) -> Self::Output {
        self.translate_simd_shift::<u16>(Op::i16x8_shl, Op::i16x8_shl_by, simd::i16x8_shl)
    }

    fn visit_i16x8_shr_s(&mut self) -> Self::Output {
        self.translate_simd_shift::<u16>(Op::i16x8_shr_s, Op::i16x8_shr_s_by, simd::i16x8_shr_s)
    }

    fn visit_i16x8_shr_u(&mut self) -> Self::Output {
        self.translate_simd_shift::<u16>(Op::i16x8_shr_u, Op::i16x8_shr_u_by, simd::i16x8_shr_u)
    }
    ...
    fn visit_i32x4_shl(&mut self) -> Self::Output {
        self.translate_simd_shift::<u32>(Op::i32x4_shl, Op::i32x4_shl_by, simd::i32x4_shl)
    }

    fn visit_i32x4_shr_s(&mut self) -> Self::Output {
        self.translate_simd_shift::<u32>(Op::i32x4_shr_s, Op::i32x4_shr_s_by, simd::i32x4_shr_s)
    }

    fn visit_i32x4_shr_u(&mut self) -> Self::Output {
        self.translate_simd_shift::<u32>(Op::i32x4_shr_u, Op::i32x4_shr_u_by, simd::i32x4_shr_u)
    }
    ...
    fn visit_i64x2_shl(&mut self) -> Self::Output {
        self.translate_simd_shift::<u64>(Op::i64x2_shl, Op::i64x2_shl_by, simd::i64x2_shl)
    }

    fn visit_i64x2_shr_s(&mut self) -> Self::Output {
        self.translate_simd_shift::<u64>(Op::i64x2_shr_s, Op::i64x2_shr_s_by, simd::i64x2_shr_s)
    }

    fn visit_i64x2_shr_u(&mut self) -> Self::Output {
        self.translate_simd_shift::<u64>(Op::i64x2_shr_u, Op::i64x2_shr_u_by, simd::i64x2_shr_u)
    }
    ...
    fn visit_f32x4_relaxed_madd(&mut self) -> Self::Output {
        self.translate_simd_ternary(Op::f32x4_relaxed_madd, simd::f32x4_relaxed_madd)
    }

    fn visit_f32x4_relaxed_nmadd(&mut self) -> Self::Output {
        self.translate_simd_ternary(Op::f32x4_relaxed_nmadd, simd::f32x4_relaxed_nmadd)
    }

    fn visit_f64x2_relaxed_madd(&mut self) -> Self::Output {
        self.translate_simd_ternary(Op::f64x2_relaxed_madd, simd::f64x2_relaxed_madd)
    }

    fn visit_f64x2_relaxed_nmadd(&mut self) -> Self::Output {
        self.translate_simd_ternary(Op::f64x2_relaxed_nmadd, simd::f64x2_relaxed_nmadd)
    }
