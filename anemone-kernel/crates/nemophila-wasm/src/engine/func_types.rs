...
/// - Requires a lot less memory footprint to be stored somewhere compared to a
///   full fledged [`FuncType`].
///
/// Disadvantages compared to non-deduplicated [`FuncType`] are:
///
/// - Requires another indirection to acquire information such as parameter or
///   result types of the underlying [`FuncType`].
