...
use crate::{
    collections::Map, engine::DedupFuncType, memory::DataSegment, module::FuncIdx, ElementSegment,
    Extern, ExternType, Func, Global, Memory, Module, Table,
};
...
impl InstanceEntityBuilder {
    ...
    /// Pushes a new [`Extern`] under the given `name` to the [`InstanceEntity`]
    /// under construction.
    ///
    /// # Panics
    ///
    ...
    /// Pushes the [`ElementSegment`] to the [`InstanceEntity`] under
    /// construction.
