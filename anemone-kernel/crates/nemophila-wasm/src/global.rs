...
use crate::{
    collections::arena::ArenaIndex, core::CoreGlobal, errors::GlobalError, GlobalType, Mutability,
    Val,
};
...
impl Global {
    ...
    /// - If there is a type mismatch between the global variable and the new
    ///   value.
    ///
    /// # Panics
    ///
