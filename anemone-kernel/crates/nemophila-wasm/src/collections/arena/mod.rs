...
//! These data structures mainly serve as the backbone for an efficient
//! WebAssembly store, module, instance and engine implementation.
    ...
    Idx: ArenaIndex,
{
    ...
    /// Returns an exclusive reference to the pair of entities at the given
    /// indices if any.
    ///
