...
impl ExternIdx {
    /// Create a new [`ExternIdx`] from the given [`wasmparser::ExternalKind`]
    /// and `index`.
    ///
    /// # Errors
    ///
...
///
/// This type is primarily accessed from the [`Module::exports`] method and
/// describes what names are exported from a Wasm [`Module`] and the type of the
