...
/// # Note
///
/// Provides a subset of the interface provided by Rust's
/// [`std::io::Read`][std_io_read] trait.
///
...
pub trait Read {
    ...
    /// # Note
    ///
    /// Provides the same guarantees to the caller as
    /// [`std::io::Read::read`][io_read_read].
    ///
