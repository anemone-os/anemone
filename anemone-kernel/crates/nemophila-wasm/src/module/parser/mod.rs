use super::{
    ...
    ElementSegment, FuncIdx, ModuleBuilder,
};
use crate::{
...
impl ModuleParser {
    ...
    fn process_end(&mut self, offset: usize) -> Result<(), Error> {
        if let Some(validator) = &mut self.validator {
            // This only checks if the number of code section entries and data segments
            // match their expected numbers thus we must avoid this check in
            // header-only mode because otherwise we will receive errors for
            // unmatched data section entries.
    ...
    /// # Note
    ///
    /// This extracts all function declarations into the [`Module`] under
    /// construction.
    ///
    /// # Errors
    ///
    ...
    /// # Note
    ///
    /// This extracts all table declarations into the [`Module`] under
    /// construction.
    ///
    /// # Errors
    ///
    ...
    /// # Note
    ///
    /// This extracts all linear memory declarations into the [`Module`] under
    /// construction.
    ///
    /// # Errors
    ///
    ...
    /// # Note
    ///
    /// This extracts all global variable declarations into the [`Module`] under
    /// construction.
    ///
    /// # Errors
    ///
    ...
    /// # Note
    ///
    /// This extracts all export declarations into the [`Module`] under
    /// construction.
    ///
    /// # Errors
    ///
    ...
    /// # Note
    ///
    /// This extracts all table element segments into the [`Module`] under
    /// construction.
    ///
    /// # Errors
    ///
    ...
    /// # Note
    ///
    /// This is part of the bulk memory operations Wasm proposal and not yet
    /// supported by Wasmi.
    ...
    /// Process an unexpected, unsupported or malformed Wasm module section
    /// payload.
