...
pub enum InstantiationError {
    ...
    /// Caused when an element segment does not fit into the specified table
    /// instance.
    ElementSegmentDoesNotFit {
        ...
        table_index: u64,
        /// The amount of elements with which the table is initialized at the
        /// `offset`.
        len: u32,
    },
    /// Caused when the `start` function was unexpectedly found in the
    /// instantiated module.
    UnexpectedStartFn {
