use crate::{
    ...
    ExternRef, Func, Ref, ValType, F32, F64, V128,
};
...
/// integers and floating-point (IEEE 754-2008) data of 32 or 64 bit width each,
/// respectively.
///
...
impl Val {
    ...
    /// Returns the underlying `i32` if the type matches otherwise returns
    /// `None`.
    ...
    /// Returns the underlying `i64` if the type matches otherwise returns
    /// `None`.
    ...
    /// Returns the underlying `f32` if the type matches otherwise returns
    /// `None`.
    ...
    /// Returns the underlying `f64` if the type matches otherwise returns
    /// `None`.
    ...
    /// Returns the underlying `funcref` if the type matches otherwise returns
    /// `None`.
    ...
    /// Returns the underlying `externref` if the type matches otherwise returns
    /// `None`.
