    ...
    K: Hash + Ord,
{
    ...
    /// of the default function. This method allows for generating
    /// key-derived values for insertion by providing the default function a
    /// reference to the key that was moved during the `.entry(key)` method
    /// call.
    ///
