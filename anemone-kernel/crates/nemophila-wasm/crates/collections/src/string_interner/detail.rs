...
impl StringInterner {
    ...
    /// # Note
    ///
    /// - Optimized for `string` not to be contained in [`StringInterner`]
    ///   before this operation.
    /// - Allocates `string` twice on the heap if it already existed prior to
    ///   this operation.
    ...
    /// # Note
    ///
    /// - Optimized for `string` to already be contained in [`StringInterner`]
    ///   before this operation.
    /// - Queries the position within `strings2symbol` twice in case `string`
    ///   already existed.
    #[inline]
