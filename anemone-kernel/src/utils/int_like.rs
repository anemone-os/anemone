//! Macros for defining newtypes that wrap integers, and atomic versions of
//! those newtypes.
//!
//! Ported from Redox. See https://github.com/redox-os/kernel/blob/master/src/common/int_like.rs.
