...
pub const SYS_PERF_OBSERVE: u64 = SYS_ANEMONE_START + 2;

pub const SYS_NEMOPHILA_LOAD: u64 = SYS_ANEMONE_START + 3;
pub const SYS_NEMOPHILA_TRY_UNLOAD: u64 = SYS_ANEMONE_START + 4;
