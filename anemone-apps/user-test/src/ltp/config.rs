...
pub(super) const LTP_GROUPS: &[LtpGroup] = &[
    ...
    LtpGroup {
        ...
        cases: include_str!("../../ltp/groups/copy-file-range.txt"),
    },
    LtpGroup {
        name: "credentials",
    ...
    LtpGroup {
        name: "flock",
        cases: include_str!("../../ltp/groups/flock.txt"),
    },
    LtpGroup {
        name: "fd",
    ...
    LtpGroup {
        name: "signalfd",
        cases: include_str!("../../ltp/groups/signalfd.txt"),
    },
    LtpGroup {
        name: "socket",
        cases: include_str!("../../ltp/groups/socket.txt"),
    },
    LtpGroup {
        name: "socketpair",
        cases: include_str!("../../ltp/groups/socketpair.txt"),
    },
    LtpGroup {
        name: "splice",
